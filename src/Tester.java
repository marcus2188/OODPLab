...
//        cineplex1.printCinemas();
        ...
        Movie movie1 = new Movie("Hello world", "Now Showing", (LocalDate) null, "World says hello to all", "Owen Noel", cast, 5.0, true, r, 9999999, ms);
        movie1.printMovie();
        Movie movie2 = new Movie("Hello world", "Now Showing", (LocalDate) null, "World says hello to all", "Owen Noel", cast, 5.0, true, r, 9999999, ms);
        movie2.printMovie();
...
>>>>>>> 8c21790cb6e2bc54462d4b317dfbc5f05e3acaeb
